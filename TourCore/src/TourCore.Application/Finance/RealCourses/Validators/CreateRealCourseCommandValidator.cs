...
{
    public class CreateRealCourseCommandValidator
    {
        public void ValidateAndThrow(CreateRealCourseCommand command)
        {
        ...
        public IReadOnlyDictionary<string, string[]> Validate(CreateRealCourseCommand command)
        {
