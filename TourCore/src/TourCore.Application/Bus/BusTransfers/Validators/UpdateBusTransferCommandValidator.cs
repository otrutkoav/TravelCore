...
namespace TourCore.Application.Bus.BusTransfers.Validators
{
    public class UpdateBusTransferCommandValidator
    {
        public void ValidateAndThrow(UpdateBusTransferCommand command)
        {
        ...
        public IReadOnlyDictionary<string, string[]> Validate(UpdateBusTransferCommand command)
        {
