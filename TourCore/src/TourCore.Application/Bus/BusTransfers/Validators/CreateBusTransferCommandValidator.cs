...
{
    public class CreateBusTransferCommandValidator
    {
        public void ValidateAndThrow(CreateBusTransferCommand command)
        {
        ...
        public IReadOnlyDictionary<string, string[]> Validate(CreateBusTransferCommand command)
        {
