...
{
    public class CreateBusTransferPointHandler : ICommandHandler<CreateBusTransferPointCommand, BusTransferPointDto>
    {
        ...
        private readonly CreateBusTransferPointCommandValidator _validator;

        public CreateBusTransferPointHandler(
            ...
            CreateBusTransferPointCommandValidator validator)
        {
        ...
        public async Task<BusTransferPointDto> Handle(CreateBusTransferPointCommand command, CancellationToken cancellationToken)
        {
            ...
            var entity = new BusTransferPoint(
            ...
            await _busTransferPointRepository.AddAsync(entity, cancellationToken);
