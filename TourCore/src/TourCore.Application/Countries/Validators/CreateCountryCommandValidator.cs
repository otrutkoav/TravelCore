...
{
    /// <summary>
    /// Я делаю простые валидаторы без FluentValidation, чтобы Application оставался максимально нейтральным.
    /// </summary>
    public class CreateCountryCommandValidator
    {
        ...
        public IReadOnlyCollection<string> Validate(CreateCountryCommand command)
        {
