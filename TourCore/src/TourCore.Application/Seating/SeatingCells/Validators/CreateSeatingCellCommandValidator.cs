...
{
    public class CreateSeatingCellCommandValidator
    {
        public void ValidateAndThrow(CreateSeatingCellCommand command)
        {
        ...
        public IReadOnlyDictionary<string, string[]> Validate(CreateSeatingCellCommand command)
        {
