...
{
    public class UpdateCharterHandler : ICommandHandler<UpdateCharterCommand, CharterDto>
    {
        ...
        private readonly UpdateCharterCommandValidator _validator;

        public UpdateCharterHandler(
            ...
            UpdateCharterCommandValidator validator)
        {
        ...
        public async Task<CharterDto> Handle(UpdateCharterCommand command, CancellationToken cancellationToken)
        {
            _validator.ValidateAndThrow(command);

            var entity = await _charterRepository.GetByIdAsync(command.Id, cancellationToken);
            if (entity == null)
