...
{
    public class UpdateAccommodationPlacementRuleCommandValidator
    {
        public void ValidateAndThrow(UpdateAccommodationPlacementRuleCommand command)
        {
        ...
        public IReadOnlyDictionary<string, string[]> Validate(UpdateAccommodationPlacementRuleCommand command)
        {
