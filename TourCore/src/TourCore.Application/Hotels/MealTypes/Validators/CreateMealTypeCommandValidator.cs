...
namespace TourCore.Application.Hotels.MealTypes.Validators
{
    public class CreateMealTypeCommandValidator
    {
        public void ValidateAndThrow(CreateMealTypeCommand command)
        {
        ...
        public IReadOnlyDictionary<string, string[]> Validate(CreateMealTypeCommand command)
        {
