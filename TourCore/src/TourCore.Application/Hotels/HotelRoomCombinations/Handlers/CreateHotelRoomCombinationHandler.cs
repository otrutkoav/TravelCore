...
using TourCore.Application.Hotels.HotelRoomCombinations.Commands;
using TourCore.Application.Hotels.HotelRoomCombinations.Mappings;
using TourCore.Application.Hotels.HotelRoomCombinations.Validators;

namespace TourCore.Application.Hotels.HotelRoomCombinations.Handlers
{
    public class CreateHotelRoomCombinationHandler : ICommandHandler<CreateHotelRoomCombinationCommand, HotelRoomCombinationDto>
    {
        ...
        private readonly CreateHotelRoomCombinationCommandValidator _validator;

        public CreateHotelRoomCombinationHandler(
            ...
            CreateHotelRoomCombinationCommandValidator validator)
        {
        ...
        public async Task<HotelRoomCombinationDto> Handle(CreateHotelRoomCombinationCommand command, CancellationToken cancellationToken)
        {
            ...
            var entity = new HotelRoomCombination(
                command.RoomTypeId,
                command.RoomCategoryId,
                command.AccommodationTypeId,
            ...
            await _hotelRoomCombinationRepository.AddAsync(entity, cancellationToken);
