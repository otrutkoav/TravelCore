namespace TourCore.Application.Common.Errors
{
    public static class ErrorCode
    {
        ...
        public const string HotelCodeExists = "hotel_code_exists";
        ...
        // AccommodationType
        public const string AccommodationTypeNotFound = "accommodation_type_not_found";
        public const string AccommodationTypeCodeExists = "accommodation_type_code_exists";
        ...
        // TrainSchedule
        public const string TrainScheduleNotFound = "train_schedule_not_found";

        // Transport
        public const string TransportNotFound = "transport_not_found";

        // Transfer
        public const string TransferNotFound = "transfer_not_found";
        public const string TransferDirectionNotFound = "transfer_direction_not_found";

        // Seating
        public const string SeatingCellNotFound = "seating_cell_not_found";
        public const string VehiclePlanNotFound = "vehicle_plan_not_found";

        // AccommodationPlacementRule
        public const string AccommodationPlacementRuleNotFound = "accommodation_placement_rule_not_found";
        public const string AccommodationPlacementRuleAgeRangeNotFound = "accommodation_placement_rule_age_range_not_found";
