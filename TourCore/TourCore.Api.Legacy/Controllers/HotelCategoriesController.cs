...
namespace TourCore.Api.Legacy.Controllers.Hotels
{
    ...
    public class HotelCategoriesController : ApiController
    {
        ...
        private readonly IQueryHandler<GetHotelCategoriesQuery, ListResult<HotelCategoryListItemDto>> _getListHandler;
        ...
        public HotelCategoriesController(
            ...
            IQueryHandler<GetHotelCategoriesQuery, ListResult<HotelCategoryListItemDto>> getListHandler,
