...
namespace TourCore.Api.Legacy.Controllers.Railway
{
    ...
    public class RailwayTransfersController : ApiController
    {
        ...
        private readonly IQueryHandler<GetRailwayTransfersQuery, PagedResponseDto<RailwayTransferListItemDto>> _getListHandler;
        ...
        public RailwayTransfersController(
            ...
            IQueryHandler<GetRailwayTransfersQuery, PagedResponseDto<RailwayTransferListItemDto>> getListHandler,
        ...
        ///
        /// Фильтрация:
        /// - query.filter.search — поиск по названию ЖД-переезда.
        ...
        /// </remarks>
        /// <param name="query">
        /// Параметры фильтрации, пагинации и сортировки ЖД-переездов.
        /// </param>
        /// <returns>Страница списка ЖД-переездов.</returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> Get([FromUri] GetRailwayTransfersQuery query)
        {
            var result = await _getListHandler.Handle(
                query ?? new GetRailwayTransfersQuery(),
